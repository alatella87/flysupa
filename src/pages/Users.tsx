  ...
  const columns: ColumnDef<Profile>[] = [
      ...
      cell: ({ row }) => {
        ...
        return (
          <Avatar
            ...
            lessonsCount={profile.total_hours || 0}
          />
        );
      },
    },
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <Badge variant={badgeVariant} className="text-sm dark:border-slate-600">
            {daysLeft < 0
    ...
    {
      id: "actions",
      header: () => <div className="text-right dark:text-slate-100">Azioni</div>,
      cell: ({ row }) => {
        const profile = row.original;
        return (
